...
public class Grid<TGridObject> {
    ...
    public Grid(int width, int height, float cellSize, Vector3 originPosition, Func<Grid<TGridObject>, int, int, TGridObject> createGridObject, Font font) {
        this.width = width;
        this.height = height;
        ...
        if (showDebug) {
            ...
            Debug.DrawLine(GetWorldPosition(0, height), GetWorldPosition(width, height), Color.white, 8000f);
            Debug.DrawLine(GetWorldPosition(width, 0), GetWorldPosition(width, height), Color.white, 8000f);
